...
// Knight Routing Types

// RouteRequest represents a request to route an intent to a knight.
...
// RouteResponse represents the result of a routing decision.
type RouteResponse struct {
	...
	Tensor          map[string]interface{} `json:"tensor"`
}
