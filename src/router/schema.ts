...
export function validateA2ARequest(payload: unknown): payload is A2ARequest {
  ...
  return (
    ...
    (p.params.virtual_key === undefined ||
      (typeof p.params.virtual_key === 'string' && p.params.virtual_key.startsWith('brvk_'))) &&
    ...
    (p.params.template_params === undefined ||
      (typeof p.params.template_params === 'object' &&
        p.params.template_params !== null &&
        Object.values(p.params.template_params).every((v) => typeof v === 'string')))
  );
}
