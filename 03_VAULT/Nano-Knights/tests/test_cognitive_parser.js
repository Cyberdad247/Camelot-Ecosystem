...
const test1 = CognitiveParser.parse("[AttentionFocus: User query analysis]\n[OUTPUT START]\nFinal response");
...
assertEqual(test2.tags.TheoryOfMind, "User expects simplicity", "Test 2: Multiple tags - TheoryOfMind");
assertEqual(test2.tags.ReasoningPathway, "Check credentials → Verify 2FA", "Test 2: Multiple tags - ReasoningPathway");
...
assert(test6.tags.CognitiveOperations.includes("ANALYZE"), "Test 6: CognitiveOperations with array");
