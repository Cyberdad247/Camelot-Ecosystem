...
const preciseContractInput = document.getElementById('preciseContractInput');
const btnLoadPrecise = document.getElementById('btnLoadPrecise');
const btnSavePrecise = document.getElementById('btnSavePrecise');
const btnDeployPrecise = document.getElementById('btnDeployPrecise');
const btnStopPrecise = document.getElementById('btnStopPrecise');
const btnSyncPreciseLedger = document.getElementById('btnSyncPreciseLedger');
const preciseStatus = document.getElementById('preciseStatus');
const preciseRuntime = document.getElementById('preciseRuntime');
const preciseProxyHost = document.getElementById('preciseProxyHost');
const preciseProxyPort = document.getElementById('preciseProxyPort');
...
loadPreciseContract();
refreshPreciseStatus();
setInterval(refreshPreciseStatus, 3000);
