        ...
        <div className="flex items-center mb-2">
          ...
          <div className="h-10 w-10 text-emerald-500 mr-4 relative">
            <svg viewBox="0 0 24 24" fill="none" className="absolute">
              ...
              <path d="M10 6H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
              <path d="M7 6H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                ...
                <div className="flex items-start mb-3">
                  <div className="mr-3">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700/50 rounded-full border border-gray-600">
                      {post.platform === 'facebook' ? (
                        <div className="text-blue-500">{getPlatformIcon('facebook')}</div>
                      ) : post.platform === 'x' ? (
                  ...
                  <div>
                    <div className="flex items-center flex-wrap gap-2">
                      <h2 className="text-lg font-semibold text-white">{post.author_name}</h2>
                      {post.author_handle && (
                    ...
                    <div className="text-gray-400 text-sm">{formatDate(post.post_datetime)}</div>
                  </div>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-md p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between py-2 border-b border-gray-700">
                  ...
                  <span className="text-white font-medium">{formatDate(post.post_datetime)}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-700">
