          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverArticles ? 'scale-110' : ''}`}>
                  <svg
            ...
            >
              <div className="absolute bottom-0 right-0 h-16 w-16 opacity-10">
                ...
                <svg
                  ...
                  className="text-emerald-500"
                >
                  <path d="M10,30 Q25,10 40,30 Q55,50 70,30 Q85,10 100,30" strokeWidth="1" />{' '}
                  <path d="M10,50 Q25,30 40,50 Q55,70 70,50 Q85,30 100,50" strokeWidth="1" />{' '}
                  <path d="M10,70 Q25,50 40,70 Q55,90 70,70 Q85,50 100,70" strokeWidth="1" />
                </svg>
              </div>
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverPodcasts ? 'scale-110' : ''}`}>
                  <svg
                    className={cardIconClasses}
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <div>
                  ...
                  <p className={cardDescriptionClasses}>Podcasts from your curated sources.</p>{' '}
                </div>
              </div>
            ...
            >
              ...
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverStudio ? 'scale-110' : ''}`}>
                  <svg
                    className={cardIconClasses}
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            >
              <div className="absolute bottom-0 right-0 h-16 w-16 opacity-10">
                ...
                >
                  ...
                  <line x1="50" y1="50" x2="35" y2="35" strokeWidth="2" strokeLinecap="round" />{' '}
                  <circle cx="50" cy="50" r="5" fill="currentColor" />
                </svg>
              </div>
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverVoyager ? 'scale-110' : ''}`}>
                  <svg
            ...
            >
              <div className="absolute bottom-0 right-0 h-16 w-16 opacity-10">
                <BrainCircuit strokeWidth={0.7} className="w-3/4 h-3/4 text-emerald-500" />
              </div>
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverSocial ? 'scale-110' : ''}`}>
            ...
            >
              ...
              <div className={cardFlexContainerClasses}>
                <div className={`${cardIconContainerClasses} ${hoverSources ? 'scale-110' : ''}`}>
                  <svg
                    className={cardIconClasses}
                    viewBox="0 0 24 24"
                    fill="none"
