      ...
      >
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-md shadow-2xl max-w-md w-full p-6 backdrop-blur">
          ...
          <p className="text-gray-300 mb-8 text-center">
            Create professional podcasts from your trusted sources with AI assistance. Choose an
            existing chat from the sidebar or create a new one to get started.
          </p>
          {error && (
          ...
          <div className="mt-8 space-y-2">
            ...
            <div className="flex items-start">
              ...
              <p className="ml-3 text-sm text-gray-300">Generate podcast scripts on any topic</p>
            </div>
            <div className="flex items-start">
              <div className="h-5 w-5 rounded-full bg-emerald-900/50 border border-emerald-800/50 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="h-3 w-3 text-emerald-400" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="flex items-start">
              ...
              <p className="ml-3 text-sm text-gray-300">Generate professional voice narration</p>
            </div>
          </div>
        </div>
      </div>
