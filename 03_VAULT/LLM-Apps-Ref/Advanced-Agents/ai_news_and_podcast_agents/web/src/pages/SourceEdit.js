                ...
                <div className="flex">
                  ...
                  >
                    ...
                    {categories.map((category) => (
                      ...
                      >
                        {category.name} {source.categories.includes(category.name) ? '(Added)' : ''}
                      </option>
                    ))}
                  ...
                  <button
                    ...
                    disabled={
                      (!newCategory && !showCustomInput) || (showCustomInput && !customCategory)
                    }
            ...
            {isNewSource && (
              <div className="border-t border-gray-700 pt-4 mt-2">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  You can add a feed URL to start collecting content from this source. More feeds
                  can be added later.
                </p>
                <div>
                  <label
