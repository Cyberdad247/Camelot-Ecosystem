                  ...
                  {source.feeds.map((feed) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm">
                        <div className="text-gray-300 truncate max-w-xs">{feed.feed_url}</div>
                        {feed.description && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-sm max-w-md w-full p-6 shadow-2xl border border-gray-700 relative">
            ...
            <form onSubmit={handleAddFeed}>
              <div className="mb-4">
                <label htmlFor="feed_url" className="block text-sm font-medium text-gray-300 mb-1">
              ...
              <div className="mb-4">
                <label htmlFor="feed_type" className="block text-sm font-medium text-gray-300 mb-1">
                  Feed Type
                </label>
                <select
                  id="feed_type"
