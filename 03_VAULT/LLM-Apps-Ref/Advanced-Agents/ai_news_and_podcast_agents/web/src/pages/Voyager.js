              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {tasks.map((task) => (
                      <tr key={task.id} className="hover:bg-gray-800 transition-all duration-200">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <div className="flex items-center">
                            <ToggleSwitch
                              ...
                              onChange={() => handleTaskToggle(task.id, task.enabled)}
                            />
                            <span
                ...
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {podcastConfigs.map((config) => (
                      <tr key={config.id} className="hover:bg-gray-800 transition-all duration-200">
                        <td className="px-4 py-3 whitespace-nowrap">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <div className="flex items-center">
                            <ToggleSwitch
                              ...
                              onChange={() => handleConfigToggle(config.id, config.is_active)}
                            />
                            <span
                              className={`ml-2 text-sm ${
                                config.is_active ? 'text-emerald-400' : 'text-gray-500'
                              }`}
                            >
                    ...
                    {taskExecutions.map((execution) => (
                      ...
                      >
                        <td className="px-4 py-3 whitespace-nowrap">
                          ...
                          <div className="text-xs text-gray-500">ID: {execution.task_id}</div>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                          <span
                        ...
                        <td className="px-4 py-3 text-sm text-gray-400">
                          <div className="flex items-center">
                            ...
                            {execution.output && (
                              <button
                                onClick={() =>
                                  handleViewOutput(execution.output, execution.task_name)
                                }
                ...
                {taskExecutions.length > 0 && (
                  <div className="mt-4 flex items-center justify-between">
                    <div className="text-sm text-gray-400">
                      Showing{' '}
                      <span className="font-medium text-gray-300">{taskExecutions.length}</span> of{' '}
                      <span className="font-medium text-gray-300">{executionsTotal}</span> results
                    </div>
        ...
        >
          ...
          <div className="flex items-center justify-center min-h-screen p-4">
            ...
            >
              ...
              <h2 className="text-xl font-medium text-gray-200 mb-4">
                {currentConfig ? 'Edit Podcast Configuration' : 'Create New Podcast Configuration'}
              </h2>
              <PodcastConfigForm
