  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const configData = {
        ...
        time_range_hours: Number.parseInt(timeRangeHours),
        limit_articles: Number.parseInt(limitArticles),
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="timeRangeHours" className="block text-sm font-medium text-gray-300 mb-1">
            Time Range (hours)
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="limitArticles" className="block text-sm font-medium text-gray-300 mb-1">
            Article Limit
          </label>
          <input
            type="number"
            ...
            className="w-full px-3 py-2 bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-700 rounded-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-400 sm:text-sm text-gray-300"
          />
          <p className="mt-1 text-xs text-gray-400">Maximum number of articles to include (5-50)</p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
        ...
        <div>
          <label htmlFor="languageCode" className="block text-sm font-medium text-gray-300 mb-1">
            Language
          </label>
          <select
            id="languageCode"
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-400">
          Advanced: Custom prompt to override the default podcast script generation instructions.
        </p>
      </div>
      <div>
