      ...
      >
        ...
        <div className="flex flex-col space-y-6 text-center">
          ...
          <Link
            to="/articles"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-lg ${isActive('/articles') ? 'text-emerald-400' : 'text-gray-200'}`}
          >
            Articles
          </Link>
          <Link
            to="/podcasts"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-lg ${isActive('/podcasts') ? 'text-emerald-400' : 'text-gray-200'}`}
          >
            Podcasts
          </Link>
          <Link
            to="/studio"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-lg ${isActive('/studio') ? 'text-emerald-400' : 'text-gray-200'}`}
          >
            Studio
          </Link>
          <Link
          ...
          <Link
            to="/voyager"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-lg ${isActive('/voyager') ? 'text-emerald-400' : 'text-gray-200'}`}
          >
            Voyager
          </Link>
          <Link
            to="/sources"
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-lg ${isActive('/sources') ? 'text-emerald-400' : 'text-gray-200'}`}
          >
            Sources
          </Link>
        </div>
