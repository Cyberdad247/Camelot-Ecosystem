...
const ScriptConfirmation = ({
  ...
  const formatScriptMarkdown = (text) =>
    text
      ...
      .replace(/^## (.*$)/gm, '<h2 class="text-sm font-semibold mt-2 mb-1 text-gray-100">$1</h2>')
              ...
              {hasStructuredScript ? (
                <div className="flex flex-col sm:flex-row h-full">
                  <div className="sm:w-56 border-b sm:border-b-0 sm:border-r border-gray-700/30 bg-gray-800/30 flex-shrink-0">
                    <div className="sm:hidden p-2">
                      <h4 className="text-xs font-medium text-gray-300 mb-2">Sections</h4>
                      ...
                      {scriptData.sections.map((section, sectionIndex) => (
                        <div
                          ...
                          className={`mb-4 sm:mb-6 ${
                            selectedSection !== null && selectedSection !== sectionIndex
                              ? 'hidden'
                              : ''
                          }`}
                        >
                ...
                <div className="p-2 sm:p-4 overflow-y-auto h-full">
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: DOMPurify.sanitize(formatScriptMarkdown(scriptText)),
                    }}
                  />
                </div>
              )}
