      ...
      {isOpen && (
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg rounded-sm p-4 mb-4 border border-gray-700">
          ...
          >
            ...
            <div>
              <label htmlFor="sentiment" className="block text-xs font-medium text-gray-300 mb-1">
                Sentiment
              </label>
              <select
                id="sentiment"
            ...
            <div className="flex space-x-2">
              <div className="w-1/2">
                <label htmlFor="dateFrom" className="block text-xs font-medium text-gray-300 mb-1">
                  From Date
                </label>
                <input
                  type="date"
              ...
              <div className="w-1/2">
                <label htmlFor="dateTo" className="block text-xs font-medium text-gray-300 mb-1">
                  To Date
                </label>
                <input
                  type="date"
