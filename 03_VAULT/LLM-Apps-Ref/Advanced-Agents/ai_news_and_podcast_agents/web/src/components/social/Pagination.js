...
const Pagination = ({ pagination, handlePrevPage, handleNextPage, setPagination }) => {
  return (
    <div className="mt-6 flex items-center justify-between bg-gradient-to-r from-gray-800 to-gray-900 p-3 rounded-sm border-t border-gray-700 shadow-lg">
      <div className="flex items-center text-xs text-gray-400">
        Showing <span className="font-medium text-gray-300 px-1">{pagination.perPage}</span> of{' '}
        <span className="font-medium text-gray-300 px-1">{pagination.total}</span> results
      </div>
