                  ...
                  <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 rounded-xl border border-gray-700/30 overflow-hidden">
                    <div className="p-3 border-b border-gray-700/30 bg-gray-800/30">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs text-gray-400">{sources.length} sources</div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <p className="text-xs text-gray-400">View Browser Use Recording</p>
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-white truncate">{podcastTitle}</p>
            ...
            <div className="w-full h-full flex flex-col">
              <div className="p-6 border-b border-gray-700/30 flex items-center justify-between flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xs font-semibold text-white">Browser Use Recording</h3>
