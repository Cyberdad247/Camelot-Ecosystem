...
export const ROUND_TABLE = {
    'LADY_APIS': {
        ...
        name: 'Lady Apis',
        title: 'The Forager',
        description: 'Deep Research & Documentation Specialist. Excels at traversing API docs and finding hidden endpoints.',
    ...
    'SIR_SYNTAX': {
        ...
        name: 'Sir Syntax',
        title: 'The Builder',
        description: 'Code Generation & Implementation Specialist. Converts requirements into executable logic.',
    ...
    'SIR_DEBUG': {
        ...
        name: 'Sir Debug',
        title: 'The Healer',
        description: 'Error Analysis & Remediation Specialist. Diagnoses crashes and optimizes performance.',
        profile_bias: 'default',
        system_prompt: `
