...
assert(test3.some(m => m.skill === "SUMMARIZE_CORE"), "Test 3: Summary preserved");
...
assert(test5.some(m => m.skill === "ANALYZE_SCREENSHOT"), "Test 5: Screenshot analysis preserved");
...
assert(test6[0].timestamp <= test6[test6.length - 1].timestamp, "Test 6: Chronological order maintained");
