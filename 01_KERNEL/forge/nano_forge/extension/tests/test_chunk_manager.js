...
const results1 = [
    [{ name: "Alice", _source: "1" }, { name: "Bob", _source: "2" }],
...
assert(merged3.employees && merged3.employees.length === 2, "Test 8: Object merge preserves structure");
...
const results6 = [[{ name: "Alice", _source: "1" }], null, undefined, [{ name: "Bob", _source: "2" }]];
