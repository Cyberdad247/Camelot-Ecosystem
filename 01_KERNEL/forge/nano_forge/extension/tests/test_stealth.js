...
assert(mockProfile.canvasNoise > 0 && mockProfile.canvasNoise < 0.001, "Test 1: Canvas noise in safe range");
assert(mockProfile.audioNoise > 0 && mockProfile.audioNoise < 0.001, "Test 2: Audio noise in safe range");
...
const isValidVendor = validVendors.some(v => mockProfile.webglVendor.includes(v) || v.includes(mockProfile.webglVendor));
...
assert(mockProfile.canvasNoise !== profile2.canvasNoise, "Test 5: Canvas noise varies between profiles");
assert(mockProfile.audioNoise !== profile2.audioNoise, "Test 6: Audio noise varies between profiles");
