...
async def expand_context(request: ContextExpansionRequest):
    ...
    **Example:**
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Context expansion failed: {str(e)}") from None
...
async def validate_context(request: ContextValidationRequest):
    ...
    **Example:**
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Validation failed: {str(e)}") from None
