...
class CrawlerRunConfig:
    ...
    def _get_signature(cls):
        if cls._init_signature is None:
            cls._init_signature = inspect.signature(cls.__init__)
        return cls._init_signature
    ...
    def __init__(
        ...
        # Apply specific fallbacks for parameters that default to dynamic/mutable values if not provided
    ...
    def __setattr__(self, name, value):
        ...
        if name in self._UNWANTED_PROPS:
            default_val = all_params[name].default if name in all_params else None
            if value is not default_val:
