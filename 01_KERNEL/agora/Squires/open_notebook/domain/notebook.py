...
class Source(ObjectModel):
    ...
    command: Optional[Union[str, RecordID]] = Field(default=None, description="Link to surreal-commands processing job")
    ...
    async def vectorize(self) -> None:
        ...
        try:
            ...
            delete_result = await repo_query(
                "DELETE source_embedding WHERE source = $source_id", {"source_id": ensure_record_id(self.id)}
            )
