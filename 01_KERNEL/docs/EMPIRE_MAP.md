...
```mermaid
graph TD
    User((Sovereign)) -->|Directive| L7[L7 Ethereal: Anya]
    L7 -->|Intent| L6[L6 Governance: Arthur]
    L6 -->|Law| L5[L5 Agentic: Paladin]
    
    subgraph Tri_Realm
        L5 -->|Logic| KERNEL[01_KERNEL: The Brain]
        KERNEL -->|Tools| FORGE[02_FORGE: The Factory]
        FORGE -->|Knowledge| VAULT[03_VAULT: The Memory]
    end
    
    VAULT -->|Telemetry| L1[L1 Substrate: Morgana]
    L1 -->|Feedback| User
```
