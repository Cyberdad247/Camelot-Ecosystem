...
export function SwarmRosterPanel() {
  const [agents] = useState<SwarmAgentMember[]>(SWARM_ROSTER_AGENTS);
  ...
  return (
    <div className="border-2 border-[#D4AF37]/40 bg-[#0B0B0E] p-6 shadow-[6px_6px_0px_0px_#9D4EDD] space-y-6 font-mono mb-8">
      {/* Header */}
