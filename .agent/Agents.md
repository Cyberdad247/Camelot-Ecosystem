...
| Knight ID | Domain & Core Specialization | Primary Engine / Substrate | OMH Operational Bounds |
| :--- | :--- | :--- | :--- |
| **MERLIN_Ω** | System 2 Orchestration & TTC Deep DAG | Gemini Pro / Claude Opus | Test-Time Compute (TTC) budget cap: 32K tokens |
| **ANYA_Ω** | Sovereign Compiler & Arch-Gatekeeper | Sovereign Lattice Substrate | Zero-bypass verification gate; Delta M ≤ 0.12 MiB |
| **SIR_BORIS** | Lead Architect, UI/UX & Crucible Conductor | Claude Code / Gemini | AST file patching, Brutalist tokens, worktree isolation |
| **SIR_CODEX** | Kinetic Implementer & Z3 Logic Prover | OpenAI Codex / GPT-5.5 | WASM32-WASI sandbox execution; formal proof gates |
