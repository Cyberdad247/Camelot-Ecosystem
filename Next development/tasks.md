...
- [x] P0.3 CI: run `make preflight` in pipeline (allow NO-GO to fail soft on x86 runners)
...
- [x] P1.4 wire CLI `preflight` to core scripts end-to-end on target
- [x] P1.5 Makefile/justfile targets verified on Nitro

## P2 — Trellis + Omega-Root (STUB -> done)  [depends P1]
- [x] P2.1 Trellis: fixed 512MB arena allocator + OOM-safe alloc/free + bench
- [x] P2.2 Omega-Root: wrap bwrap/unshare; immutable chroot; restore-from-breach test
