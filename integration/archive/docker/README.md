# Archived: Docker artifacts (unsupported)

νKG native-runtime correction (2026-08-07): the voice slice is a
**native-process** deployment. Docker/Kubernetes are not part of the
