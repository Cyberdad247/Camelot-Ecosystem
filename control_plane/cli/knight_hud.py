...
KNIGHT_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "SIR_LUKAS": {
        ...
        "runes": [
            ("//LUKAS_TELEMETRY", "Render verified knight/router/ledger telemetry surface"),
            ("//LUKAS_HUD <knight>", "Render round-trip-verified Knight HUD for inspection"),
            ("//LUKAS_ANOMALY <claim>", "Round-trip a claimed state against disk/git/probes"),
            ("//LUKAS_REPORT", "Emit evidence-class telemetry brief to the council"),
            ("//LUCAS_TELEMETRY", "Legacy alias for //LUKAS_TELEMETRY"),
        ],
        "base_xp": 10000,
    },
    "SIR_LUCAS": {
