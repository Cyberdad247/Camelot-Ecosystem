    ...
    <section className="h-[80vh] flex flex-col justify-center items-center bg-[#000] relative overflow-hidden">
      ...
      <div className="z-10 text-center max-w-2xl px-6">
        ...
        >
          ...
          <button
            type="submit"
            className="group bg-[#00FF99] text-black px-8 py-4 rounded-lg font-bold tracking-wider hover:bg-white transition-colors flex items-center justify-center gap-2"
          >
            ENGAGE
