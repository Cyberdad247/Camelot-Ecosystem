    ...
    return (
        <div className="flex flex-col h-full bg-black border border-purple-900 rounded-lg overflow-hidden shadow-[0_0_20px_rgba(50,0,50,0.5)]">
            <div className="bg-purple-900/20 px-4 py-2 border-b border-purple-900 flex justify-between items-center">
                <h2 className="text-xs font-black tracking-widest text-purple-400 uppercase">🧙‍♂️ Merlin Persona Studio</h2>
                ...
                <div className="flex-1 p-6 overflow-y-auto">
                    {manifest ? (
                        <div className="space-y-6">
                            ...
                            <section className="space-y-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] text-purple-400 font-bold uppercase tracking-widest">ROOT_IDENTITY</span>
                                    <div className="h-[1px] flex-1 bg-purple-900" />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setManifest({ ...manifest, root: { ...manifest.root, id: e.target.value } })}
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setManifest({ ...manifest, root: { ...manifest.root, mandate: e.target.value } })}
                                            className="w-full bg-black border border-purple-900 p-2 text-xs text-purple-300 focus:outline-none focus:border-purple-400"
                                        />
                                    </div>
                                </div>
                            ...
                            <section className="space-y-3">
                                <div className="flex items-center gap-2">
                                    <div className="h-[1px] flex-1 bg-purple-900" />
                                    <span className="text-[10px] text-purple-400 font-bold uppercase tracking-widest">COGNITIVE_BRANCH</span>
                                    <div className="h-[1px] flex-1 bg-purple-900" />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setManifest({ ...manifest, branch: { ...manifest.branch, tone: e.target.value } })}
                                            className="w-full bg-black border border-purple-900 p-2 text-xs text-purple-300 focus:outline-none focus:border-purple-400"
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setManifest({ ...manifest, branch: { ...manifest.branch, symbols: e.target.value } })}
                            ...
                            <section className="space-y-3">
                                <div className="flex items-center gap-2">
                                    <div className="h-[1px] flex-1 bg-purple-900" />
                                    <span className="text-[10px] text-purple-400 font-bold uppercase tracking-widest">LEAF_STRATEGIES</span>
                                    <div className="h-[1px] flex-1 bg-purple-900" />
                                </div>
                            ...
                            <div className="pt-4 flex items-center justify-between">
                                <span className={`text-[10px] font-bold ${message.includes('✅') ? 'text-green-500' : 'text-purple-700'}`}>
                                    {message}
                                </span>
                                <button
                                    onClick={handleSave}
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-purple-900 space-y-4">
                            ...
                            <p className="text-[10px] uppercase tracking-widest">Select an expert to begin synthesis</p>
                        </div>
                    )}
                </div>
            </div>
