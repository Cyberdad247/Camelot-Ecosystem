    ...
    <Theme name="dark">
      <YStack f={1} bg="$background" p="$4">
        <XStack ai="center" space="$2" mb="$4">
          ...
          <Text fS={22} fOW="bold">System Configuration</Text>
        </XStack>
        ...
        <ScrollView f={1} space="$4">
          ...
          <YStack space="$2">
            <XStack ai="center" space="$2">
              ...
              <Text fS={14} fOW="bold" col="$colorSecondary">KERNEL STATUS</Text>
            </XStack>
            <YStack p="$3" br="$4" bg="$color3">
              <XStack jc="space-between" ai="center">
                <Text>Status</Text>
                <Text col="$green10" fOW="bold">RADIANT</Text>
              </XStack>
            </YStack>
          </YStack>
          ...
          <YStack space="$2">
            <XStack ai="center" space="$2">
              ...
              <Text fS={14} fOW="bold" col="$colorSecondary">SECURITY & ACCESS</Text>
            </XStack>
            <YStack p="$3" br="$4" bg="$color3">
              <XStack jc="space-between" ai="center">
