...
const expectedUw =
  (BREAKPOINTS.ultrawide.baseRadius + 1 * BREAKPOINTS.ultrawide.radiusGrowth + 1.3) *
  BREAKPOINTS.ultrawide.viewportScale;
...
assert.ok(
  atFoundation.path.y - atFoundation.path.focusY < preFoundation.path.y - preFoundation.path.focusY,
