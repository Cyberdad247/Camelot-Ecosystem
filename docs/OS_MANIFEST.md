# CAMELOT OS: MANIFEST MIRROR

This file is a documentation pointer, not a canonical runtime manifest.

## Current rule

There is no maintained root `OS_MANIFEST.md` in this checkout.
Do not treat older references to a root manifest as current truth.
...
- Older docs linked to `docs/OS_MANIFEST.md`
- Keeping this file avoids dead links while redirecting readers to the actual
