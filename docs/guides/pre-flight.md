...
deprecated: "2026-07-14 — superseded by `docs/protocols/pre-flight.md`; see [Assimilation Directive §7 Q5](docs/assimilation_directive_2026-07-14.md#5--pre-flightmd-location-trinary)"
supersedes_path: "docs/protocols/pre-flight.md"
---
# 🚀 PRE-FLIGHT SWARM IGNITION CHECKLIST

> ⚠️ **DEPRECATED 2026-07-14.** This file (v4.0-FABLE_CORE, root) has been
> superseded by [`docs/protocols/pre-flight.md`](docs/protocols/pre-flight.md)
> per §7 Q5 graduation of the [Assimilation Directive](docs/assimilation_directive_2026-07-14.md).
> The **[canonical version](docs/protocols/pre-flight.md)** has the up-to-date
> 5-section template (MCP Gateway Validation, Skill Matrix Synchronization,
> Bio-Kinetic Swarm Readiness, Iron Gate v2, IGNITION_COMMAND) with
> file:line citations to `AGENTS.md`, `bio_swarm_runtime.py`, `soul_oversight.py`,
> etc. This v4.0-FABLE_CORE variant is preserved on disk for **operator
> workflow compatibility** — if any code path reads `CAMELOT_OS/pre-flight.md`,
> it continues to resolve. New code should read `docs/protocols/pre-flight.md`.
