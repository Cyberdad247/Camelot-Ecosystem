...
| claw-code-agent | harness | Sir Codex / Sir Pi | 02_FORGE/KINETIC_ARMORY/claw-code-agent | assimilated | camelot team self-test --target harness_codex --require-pass | Validate upstream license and active runtime need before deeper coupling. |
| goose | harness | Sir Hermes / Sir Link | 02_FORGE/KINETIC_ARMORY/goose | assimilated | Test-Path 02_FORGE/KINETIC_ARMORY/goose | Validate upstream license and active runtime need before deeper coupling. |
| hermes-agent | harness | Sir Hermes / Sir Link | 02_FORGE/KINETIC_ARMORY/hermes-agent | assimilated | Test-Path 02_FORGE/KINETIC_ARMORY/hermes-agent | Validate upstream license and active runtime need before deeper coupling. |
| pi-mono | harness | Sir Codex / Sir Pi | 02_FORGE/tools/pi-mono | assimilated | camelot team self-test --target harness_codex --require-pass | Validate upstream license and active runtime need before deeper coupling. |
| EXCALIBUR | kernel | Merlin | 01_KERNEL/EXCALIBUR | assimilated | camelot team roster | Validate upstream license and active runtime need before deeper coupling. |
| cribo | kinetic | Lukas / Sir Mason | 02_FORGE/KINETIC_ARMORY/cribo | assimilated | Test-Path 02_FORGE/KINETIC_ARMORY/cribo | Validate upstream license and active runtime need before deeper coupling. |
| Nano-Knights | kinetic | Lukas | 03_VAULT/Nano-Knights | assimilated | Test-Path 03_VAULT/Nano-Knights | Validate upstream license and active runtime need before deeper coupling. |
| mcp_web_search | mcp | Lady Apis | 02_FORGE/KINETIC_ARMORY/mcp_web_search | assimilated | Test-Path 02_FORGE/KINETIC_ARMORY/mcp_web_search | Validate upstream license and active runtime need before deeper coupling. |
