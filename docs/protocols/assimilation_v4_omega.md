...
graph TD
    ...
    Scout -->|Memory Crystal| Trinity{The Trinity Crucible}
    
    subgraph Trinity_Logic
        Aris[Sir Aris: Logical Validation]
        Vega[Sir Vega: Strategic Paths]
        Kaelen[Elder Kaelen: Ethical Sync]
    end
