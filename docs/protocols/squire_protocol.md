...
```mermaid
graph TD
    Forge[Sir Forge: Code Build] --> Watch[Squire Watch: Monitoring]
    Watch --> Clean[Squire Clean: Lint & Format]
    Clean --> Purge[Squire Purge: Tree-Shake & Optimize]
    Purge --> Sentinel[Sir Sentinel: Final Audit]
    Sentinel --> Stable[Stable Artifact]
```
