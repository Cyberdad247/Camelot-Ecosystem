...
## ⚓ ANCHORED SUBSTRATE NODES
| APP NAME | APP ID | FUNCTION |
| :--- | :--- | :--- |
| **excalibur-brain** | ap-L0WqJbZG2DOA8jIMSxR3R9 | Neural Reasoning & LLM Inference. |
| **tasha-voice-agent** | ap-7dHtduCGqd73th6sZF97Gs | Multimodal Voice Interaction. |
| **camelot-voice-pipeline** | ap-4zsPHxkkOzpBlh5NAT3822 | Audio Processing & Transcription. |
...
Every cloud strike must present the **Bifrost Identity Key** (`ap2_signing_key.bin`) and utilize the `cyberdad247` Modal profile shims anchored in the Vault.
...
## ⚖️ GOVERNANCE: THE MORGANA GATE
No cloud strike shall exceed 15 minutes of compute time without an explicit **{👤✅} HITL Approval** to prevent runaway resource consumption.

---
> **"From Metal to Cloud. One Lattice. One Sovereignty."**
