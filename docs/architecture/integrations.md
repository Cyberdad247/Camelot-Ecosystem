...
| 13 | **Keys-Setup…** `3fda3e85` | Inference/Research node pattern — MoA + LoRA loop (DGX Spark hardware) | `cartridges/moa-routing-capture` | **pattern ported** (bounded two-hook + weighted signal miner) |
